...
const RAIN_CONFIG: Record<"rainy" | "heavy-rainy" | "rainstorm" | "thunderstorm", { readonly count: number; readonly speed: number; readonly stagger: number }> = {
...
export function WeatherBackground({ category }: { readonly category: WeatherCategory }) {
  ...
  if (category === "rainy" || category === "heavy-rainy" || category === "rainstorm" || category === "thunderstorm") return renderRain(category);
