...
export function WeatherBackground({ category }: { readonly category: WeatherCategory }) {
  ...
  if (category === "cloudy" || category === "overcast") return <div className={`weather-bg weather-bg--${category}`} aria-hidden="true"><div className="cloud cloud--1" /><div className="cloud cloud--2" /></div>;
